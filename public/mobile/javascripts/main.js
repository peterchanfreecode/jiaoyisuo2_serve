...
/*var socket_api ="http://13.209.165.123:2000";*/
    ...
    $.ajax({
        ...
        success: function (res) {
            ...
            if (res.type == 'ok') {
                ...
                //         // 如果未认证要跳到初级认证页面
                //         setTimeout(() => {
                //             location.href = 'userCertificationFirst.html';
                //         }, 1500);
                //         break;
                //     case '1001':
                //         // 如果初级认证完成要跳到高级认证页面
                //         setTimeout(() => {
                //             location.href = 'advancedCertification.html';
                //         }, 1500);
                //         break;
                //     default:
                //         break;
...
function initDataTokens(params, callback) {
    ...
    $.ajax({
        ...
        beforeSend: function beforeSend(request) {
            request.setRequestHeader('Authorization', token);
            request.setRequestHeader('is_cn', getLocal('language') === 'zh' ? true : false);
        },
        success: function (res) {
            layer_close();
            if (res.type == 'ok') {
