			...
			le = {
				render: function() {
					...
					return a("div", {
						...
						staticClass: "bg"
					}, [a("h2", [t._v("KiBiEx " + t._s(t.$t("header.help")))])])]), t._v(" "), a("div", {
						staticClass: "helpCenter"
					}, [a("el-breadcrumb", {
							attrs: {
								separator: "/"
		...
		var Ve, He, qe, Ke, Xe, $e, ta, ea, aa = {
			...
			pa = {
				...
				lg: {
					...
					login22: "KiBiEx团队集结了丰富的业界资源。平台上线伊始，一直秉承着用户至上的理念，坚持公平、透明交易原则被全球投资人所信任。",
					login23: "多平台终端接入",
				...
				asset: {
					...
					a06: "最小充值金额：",
					a10: "你的会在3-6个网络确认后到帐。",
					a11: "所有KiBiEx的充币地址都是多重签名冷钱包地址，所有钱包均不曾被联网的机器读取。",
					ornone: "，否则资产将不可找回",
			...
			va = {
				...
				lg: {
					...
					login18: "暢通的資訊通路",
					login19: "豐富的社群活動",
					login20: "KiBiEx精英團隊由高級金融工程師，業界專業IT人士，資深區塊鏈架構師組成。在“金融衍生品設計”、",
					login21: "“量化交易工具開發”、“金融交易平臺運作”上均有優秀的過往記錄和成功的運作經驗。多年深耕於傳統金融領域的經歷讓",
					login22: "KiBiEx團隊集結了豐富的業界資源。平臺上線伊始，一直秉承著用戶至上的理念，堅持公平、透明交易原則被全球投資人所信任。",
					login23: "多平臺終端接入",
				...
				asset: {
					...
					a06: "最小充值金額：",
					a10: "你的會在3-6個網絡確認後到帳。",
					a11: "所有KiBiEx的充幣地址都是多重簽名冷錢包地址，所有錢包均不曾被聯網的機器讀取。",
					ornone: "，否則資產將不可找回",
