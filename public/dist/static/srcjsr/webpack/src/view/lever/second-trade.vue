<template>
  <div :class="skins=='nights'?'trade balck':'trade'">
    <div class="trade-currency flex">
      <div class="balance">
        <div class="flex">
          <img class="ml30" src="../../../static/imgs/money.png" alt>
          <p class="tc ft16">{{$t('asset.miscroAccount')}}</p>
        </div>
        <ul>
          <li
      ...
      <!-- <div class="insuranc">
        ...
        <div>
          <p class="mt10 tc">{{bmbBalance || '0.00' |numFilters(1)}}AITB</p>
    ...
    <!-- 买涨、买跌弹窗 -->
    <el-dialog title :visible.sync="modalShow" width="480px" top="520px" center>
