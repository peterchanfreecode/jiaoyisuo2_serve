...
return array(
    ...
    "配售额度不足" => "配售额度不足",
    "申购成功" => "申购成功",
    "不在可筹集时间范围内" => "不在可筹集时间范围内",
    "大于最高低认购" => "大于最高低认购",
    "提交成功，我们会尽快给你回复" => "提交成功，我们会尽快给你回复",
    "The 支付币种 field is required." => "参数错误",
    "请登录" => "请登录",
    ...
    "交易对不存在" => "交易对不存在",
    "交易未开启" => "交易未开启",
    "币种不存在或不允许被交易" => "币种不存在或不允许被交易",
    "到期时间不允许" => "到期时间不允许",
    "下单数量必须是整数" => "下单数量必须是整数",
    "最小下单数量不能小于:10" => "最小下单数量不能小于:10",
    "最大下单数量不能超过:10000000" => "最大下单数量不能超过:10000000",
    "邮箱已注册" => "邮箱已注册",
    "发送超出上限" => "发送超出上限",
    "最小下单数量不足" => "最小下单数量不足",
    "信用分不足请联系客服" => "信用分不足请联系客服",
    "交易量不足,请先完成交易" => "交易量不足,请先完成交易",
    "请先完成初级认证" => "请先完成初级认证",
);
