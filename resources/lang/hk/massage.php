...
return array(
    ...
    '配售额度不足' => '配售額度不足',
    '申购成功' => '申購成功',
    '不在可筹集时间范围内' => '不在可籌集時間範圍內',
    '大于最高低认购' => '大於最高低認購',
    '提交成功，我们会尽快给你回复' => '提交成功，我們會盡快給你回复',
    'The 支付币种 field is required.' => "The 支付幣種 field is required",
    "请登录" => "請登錄",
    ...
    "交易对不存在"=> "交易對不存在",
    "交易未开启" => "交易未開啟",
    "币种不存在或不允许被交易" => "幣種不存在或不允許被交易",
    "到期时间不允许"=>"到期時間不允許",
    "下单数量必须是整数"=>"下單數量必須是整數",
    "最小下单数量不能小于:10"=>"最小下單數量不能小於:10",
    "最大下单数量不能超过:10000000"=>"最大下單數量不能超過:10000000",
    "邮箱已注册"=>"郵箱已註冊",
    "发送超出上限"=>"發送超出上限",
    "最小下单数量不足"=>"最小下單數量不足",
