...
return array(
    ...
    "信用分不足请联系客服"=>"If your credit score is insufficient, please contact customer service",
    "交易量不足,请先完成交易"=>"Insufficient transaction volume, please complete the transaction first",
