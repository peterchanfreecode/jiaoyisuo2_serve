        ...
        <div class="layui-item">
            <div class="layui-inline" style="margin-left: 10px;">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="account" placeholder="请输入邮箱" autocomplete="off" class="layui-input"  value="">
                </div>
            </div>
            <div class="layui-inline" style="margin-left: 10px;">
                <label class="layui-form-label">用户ID</label>
                <div class="layui-input-inline">
                    <input type="text" name="user_id" id="user_id" placeholder="请输入用户ID" autocomplete="off"
                        ...
                        function tbRend(url) {
                            table.render({
                                ...
                                , cols: [[
                                    ...
                                    , {field: 'lock_name', title: '账户类型', width: 150}
