            ...
            <div class="layui-tab">
                ...
                <div class="layui-tab-content">
                    ...
                    <div class="layui-tab-item">
                        ...
                        <div class="layui-form-item">
                            <label class="layui-form-label">兑换手续费率</label>
                            <div class="layui-input-block">
                                <input type="text" name="exchange_rate" autocomplete="off" class="layui-input"
                                       value="@if(isset($setting['exchange_rate'])){{$setting['exchange_rate']}}@endif">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label">充币手续费率</label>
                            <div class="layui-input-block">
                                <input type="text" name="recharge_rate" autocomplete="off" class="layui-input"
                                       value="@if(isset($setting['recharge_rate'])){{$setting['recharge_rate']}}@endif">
                            </div>
                        </div>
                        <div class="layui-form-item">
...
<!--                                    <option value="2" {{ ($setting['risk_mode']?? 0) == 2 ? 'selected' : '' }} >全局群控</option>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="risk_end_ago_max"  disabled="disabled" required  lay-verify="required" placeholder="平仓前多少秒开始被风控影响" autocomplete="off" class="layui-input" value="{{ $setting['risk_end_ago_max'] ?? 0}}">
                            </div>
                        </div>
                        ...
                        <div class="layui-form-item layui-form-text" id="risk_profit_probability">
                            ...
                            <div class="layui-input-inline">
                                <input class="layui-input" type="text" disabled="disabled" name="risk_profit_probability" placeholder="" value="{{$setting['risk_profit_probability'] ?? ''}}">
                            </div>
                            <div class="layui-form-mid layui-word-aux">%</div>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <div class="layui-input-inline" style="width:100px;">
                                    <input type="text" class="layui-input layui-date" disabled="disabled" name="insurance_start" value="{{$setting['insurance_start']}}" placeholder="开始时间" >
                                </div>
                                <div class="layui-form-mid layui-word-aux">至</div>
                                <div class="layui-input-inline" style="width:100px;">
                                    <input type="text" class="layui-input layui-date"  disabled="disabled" name="insurance_end" value="{{$setting['insurance_end']}}" placeholder="结束时间">
                                </div>
                            </div>
                        </div>
                    </div>
