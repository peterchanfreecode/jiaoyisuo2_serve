                ...
                <div class="layui-colla-content layui-show">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline" style="width: 90px;">
                            <input type="text" class="layui-input" name="sort" placeholder="排序 值越大越靠前" value="{{ $currency_match->sort ??00 }}" >
                        </div>
                    </div>
                    <div class="layui-form-item">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-inline">
                            <div class="layui-input-inline" style="width: 120px;">
                                <input type="text" class="layui-input" name="fluctuate_min" placeholder="最小值" value="{{ $currency_match->fluctuate_min ?? 0.001 }}" >
                            </div>
                            <div class="layui-form-mid">-</div>
                            <div class="layui-input-inline" style="width: 120px;">
                                <input type="text" class="layui-input" name="fluctuate_max" placeholder="最大值" value="{{ $currency_match->fluctuate_max ?? 0.009}}" >
                            </div>
                        </div>
                    </div>
                    <div class="layui-form-item">
