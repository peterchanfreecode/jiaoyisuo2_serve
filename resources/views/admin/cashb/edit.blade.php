...
@section('page-content')
    <form class="layui-form" action="">
        ...
        <div class="layui-form-item">
            <label for="currency_id" class="layui-form-label">提币类型</label>
            <div class="layui-input-block">
                <select name="is_real"  lay-search>
                    <option value="">请选择</option>
                    <option value="1" @if ((isset($currency_match) && $currency_match->is_real ==1)) selected @endif>真实提币</option>
                    <option value="2" @if ((isset($currency_match) && $currency_match->is_real ==2)) selected @endif>试玩提币</option>
                </select>
            </div>
        </div>
        <div class="layui-form-item">
