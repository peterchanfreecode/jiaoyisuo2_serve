...
@section('page-head')
    <script src="/admin/plugins/layui/lay/modules/echarts.min.js"></script>
@endsection
        ...
        <div class="layui-row">
            <div class="layui-col-md4 layui-col-xs4  layui-col-md4">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input class="layui-input itime"  disabled="disabled" id="dates" name="dates" lay-verify="required"
                               placeholder="请选择时间" value="{{$itime}}"
                               type="text">
                    </div>
                </div>
            </div>
<!--            <div class="layui-col-md4 layui-col-xs4  layui-col-md4">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <select class="layui-input"  disabled="disabled" name="times" id="times" lay-verify="required">
                           @for($i=0;$i<=23;$i++)
...
<!--            <div class=" layui-col-md4 layui-col-xs4 layui-col-sm4">
            ...
            <div class="layui-col-md4 layui-col-xs4  layui-col-md4">
                ...
                <div class="layui-form-item">
                    <label class="layui-form-label">最终价格</label>
                    <div class="layui-input-block">
                        <input class="layui-input" id="end_price" name="end_price" lay-verify="required" placeholder="增长精度"  type="text">
                    </div>
                </div>
            </div>
        </div>
...
@section('scripts')
    <script type="text/javascript">
        ...
        function previewKLine() {
            ...
            $.getJSON('/admin/test/post', $('#form').serialize(), res => {
                console.log(res);
                data = res;
