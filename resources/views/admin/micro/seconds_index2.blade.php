...
@section('scripts')
    ...
    <script>
        ...
        layui.use(['table','form'], function(){
            ...
            $('#add_set').click(function(){layer_show('添加秒数', "/admin/micro_seconds_add?type={{$type}}");});

            table.render({
                elem: '#demo'
                // ,url: '{{url('admin/micro_seconds_list')}}' //数据接口
                ,url: "/admin/micro_seconds_list?type={{$type}}"
                ,page: true //开启分页
                ,id:'mobileSearch'
                ,height: 'full-100'
                ,cols: [[ //表头
                    ...
                    ,{field: 'lose_ratio', title: '亏损率', minWidth:80}
                    ,{field: 'micro_min', title: '最小数量', minWidth:120}
            ...
            table.on('tool(test)', function(obj){
                ...
                if(obj.event === 'del'){
                    ...
                    layer_show('编辑商家','/admin/micro_seconds_add?type={{$type}}&id='+data.id);
                }
            });
