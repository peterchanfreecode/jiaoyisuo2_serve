      ...
      <div class="layui-header">
        ...
        <ul class="layui-nav layui-layout-left">
          <li class="layui-nav-item layadmin-flexible" lay-unselect>
            <a href="javascript:;" layadmin-event="flexible" title="side extension">
...
<!--          <li class="layui-nav-item layui-hide-xs" lay-unselect>
          ...
          <li class="layui-nav-item" lay-unselect>
            ...
            <dl class="layui-nav-child">
              <dd><a lay-href="/agen/set_info">information</a></dd>
              <dd><a lay-href="/agen/set_password">change Password</a></dd>
              <hr>
              <dd layadmin-event="logouten" style="text-align: center;"><a>quit</a></dd>
            </dl>
          </li>
      ...
      <!-- 侧边菜单 -->
            @component('agen.layui_side_menu')
            @endcomponent
      ...
      <div class="layui-body" id="LAY_app_body">
        <div class="layadmin-tabsbody-item layui-show">
          <iframe src="/agen/home" frameborder="0" class="layadmin-iframe"></iframe>
        </div>
      </div>
