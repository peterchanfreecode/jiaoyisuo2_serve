...
<div class="layui-fluid">
  <div class="layui-row layui-col-space15">
        ...
        <div class="layui-col-sm6 layui-col-md4">
          <div class="layui-card">
            <div class="layui-card-header">
                Leverage settlement order volume
              <span class="layui-badge layui-bg-blue layuiadmin-badge">total</span>
            </div>
        ...
        <div class="layui-col-sm6 layui-col-md4">
          <div class="layui-card">
            <div class="layui-card-header">
                Number of subordinate agents
              <span class="layui-badge layui-bg-cyan layuiadmin-badge">total</span>
            </div>
            <div class="layui-card-body layuiadmin-card-list">
        ...
        <div class="layui-col-sm6 layui-col-md4">
          <div class="layui-card">
            <div class="layui-card-header">
                Total number of members under the name
              <span class="layui-badge layui-bg-green layuiadmin-badge">total</span>
            </div>
            <div class="layui-card-body layuiadmin-card-list">
