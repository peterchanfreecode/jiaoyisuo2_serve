    ...
    layui.use(['index','table' , 'layer'], function() {
        ...
        table.render({
            ...
            ,cols: [[
                ...
                ,{field: 'currency_name', width: 100, title: '币种'}
                ,{field: 'account_number', minwidth: 200,title: '用户名', totalRowText: '小计'}
                ,{field: 'belong_agent_name', minwidth: 200,title: '所属代理'}
                ,{field: 'value', title: '充币数量', totalRow: true}
                ,{field: 'info', title: '说明'}
                ,{field: 'created_time', title: '到账时间'}
            ]]
            ,page: true
            ,limit: 30
            ,height: 'full-240'
