  ...
  layui.use(['index','table', 'layer', 'laydate', 'form'], function () {
    ...
    var data_table = table.render({
      ...
      , cols: [[
        ...
        , { field: 'account', title: '用户账号', width: 160, sort: true, totalRowText: '小计' }
        ...
        , { field: 'fee', title: '手续费', width: 100, totalRow: true, templet: '<div><div style="text-align: right;"><span>@{{Number(d.fee).toFixed(4)}}</span></div></div>' }
