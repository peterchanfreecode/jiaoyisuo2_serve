...
class CurrencyController extends Controller
{
    ...
    public function lists(Request $request)
    {
        ...
        $result = $result->orderBy('sort', 'desc')->orderBy('id', 'desc')->paginate($limit);
    ...
    public function delete(Request $request)
    {
        ...
        try {
            $acceptor->delete();
            UsersWallet::where("currency",$id)->delete();
    ...
    public function matchList(Request $request)
    {
        ...
        $result = new CurrencyMatch();
        $matchs = $result->where("legal_id",$legal_id)->orderBy('id', 'desc')->paginate($limit);
