...
class ReportController extends Controller
{
    ...
    public function home()
    {
        ...
        return view("agen.home", ['settlement' => $settlement, 'subordinate_agent_num' => $subordinate_agent_num, 'subordinate_user_num' => $subordinate_user_num]);
    }

    //订单统计
    public function orderSt()
    {
        return view("agen.statistics.order");
    }

    //用户统计
    public function userSt()
    {
        return view("agen.statistics.user");
    }

    //收益统计
    public function moneySt()
    {
        return view("agen.statistics.money");
    }
