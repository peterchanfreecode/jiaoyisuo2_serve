...
class OrderController extends Controller
{
    ...
    public function transactionIndex()
    {
        ...
        return view("agen.order.transaction", [
            'legal_currencies' => $legal_currencies,
    ...
    public function microIndex()
    {
        ...
        return view("agen.order.microlist", [
            'currencies' => $currencies,
    ...
    public function microList(Request $request)
    {
        ...
        if ($results->items()) {
            foreach ($results->items() as &$v) {
                ...
                if ($v->status == 1) {
                    $v->status_en = "in transaction";
                } else if ($v->status == 2) {
                    $v->status_en = "Closing position";
                } else if ($v->status == 3) {
                    $v->status_en = "closed";
                }
                if ($v->pre_profit_result == -1) {
                    $v->pre_profit_result_name_en = "deficit";
                } else if ($v->pre_profit_result == 1) {
                    $v->pre_profit_result_name_en = "profit";
                } else {
                    $v->pre_profit_result_name_en = "flat";
                }
            }
        }
