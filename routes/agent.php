...
Route::group(['prefix' => 'agent', 'middleware' => ['agent_auth']], function () {
    ...
    Route::get('salesmen/update_agent', 'Agent\UserController@update_agent');
    Route::any('salesmen/update_agent_add', 'Agent\UserController@update_agent_add');
    ...
    Route::any('del_agent', 'Agent\MemberController@del_agent');
    Route::any('google_code', 'Agent\MemberController@google_code');
    ...
    //出入金（充币、提币)
    Route::get('recharge/index', 'Agent\CapitalController@rechargeIndex');
    Route::any('recharge/apply', 'Agent\CapitalController@rechargeApply');
    Route::any('recharge/req_show', 'Agent\CapitalController@req_show');
    Route::any('recharge/pass', 'Agent\CapitalController@passReq');
    Route::any('recharge/refuse', 'Agent\CapitalController@refuseReq');
    Route::get('withdraw/index', 'Agent\CapitalController@withdrawIndex');
    ...
    Route::any('user/flow', 'Agent\CapitalController@flow');//
    Route::any('user/flow_lists', 'Agent\CapitalController@flow_lists');//
    Route::get('capital/withdraw_show', 'Agent\CapitalController@withdraw_show');
    Route::any('capital/withdraw_done', 'Agent\CapitalController@withdraw_done');
    //用户资金
    ...
    Route::get('user/conf', 'Agent\CapitalController@conf');
    Route::post('user/conf', 'Agent\CapitalController@postConf');//调节钱包账户
    //用户订单
    ...
    Route::post('user/postRisk', 'Agent\UserController@postRisk');
    Route::any('user/update_user_agent', 'Agent\UserController@update_user_agent');//用户管理列表
    Route::any('user/doLock', 'Agent\UserController@doLock');
    Route::any('user/update_password', 'Agent\UserController@update_password');
    Route::any('user/do_update_password', 'Agent\UserController@do_update_password');
    Route::any('user/user_mic', 'Agent\UserController@user_mic');
    Route::any('user/postMicro', 'Agent\UserController@postMicro');
    Route::any('agent_report/index', 'Agent\AgentReportController@index');
    Route::any('agent_report/list', 'Agent\AgentReportController@lists');
    //初级认证
    Route::get('user/real_index', 'Agent\UserRealController@index');
    Route::get('user/real_list', 'Agent\UserRealController@list');
    Route::get('user/real_info', 'Agent\UserRealController@detail');
    Route::post('user/real_del', 'Agent\UserRealController@del');
    Route::post('user/real_auth', 'Agent\UserRealController@auth');
    // 高级认证
    Route::get('user2/real_index', 'Agent\UserReal2Controller@index');
    Route::get('user2/real_list', 'Agent\UserReal2Controller@list');
    Route::get('user2/real_info', 'Agent\UserReal2Controller@detail');
    Route::post('user2/real_del', 'Agent\UserReal2Controller@del');
    Route::post('user2/real_auth', 'Agent\UserReal2Controller@auth');
});
